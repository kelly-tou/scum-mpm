...
fixed_point_t data_matrix_buffer[9], data_matrix_v_buffer[9], computing_matrix_buffer[4];
...
bool form_data_matrix(const uint16_t* data, const size_t length, matrix_t* result) {
...
// Form (((V1')^H)^t)((V2')^H) matrix. We need to find the eigenvalues of this matrix.
