...
ax[0].plot(time_constants, mean_abs_errors, label='Matrix Pencil Method', alpha=1, marker='p')

ax[0].plot(nominal_taus, five_perc_tau, label=r'5\% of $\tau$', alpha=1, color="black", linestyle='--')
...
ax[1].plot(time_constants, std_errors, label='Matrix Pencil Method', alpha=1, marker='p')

ax[1].plot(nominal_taus, one_perc_tau, label=r'1\% of $\tau$', alpha=1, color="black", linestyle='--')
...
ax[2].plot(wlg_n, wlg_runtimes, label='Weighted Linear Fit', alpha=0.4, marker="o", color='red')
ax[2].plot(lg_n, lg_runtimes, label='Linear Fit', marker="v", alpha=0.4, color='orange')
ax[2].plot(mpm_n, mpm_runtimes, label='Matrix Pencil Method', marker='p')
