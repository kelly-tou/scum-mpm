...
matrix_t AtA;
fixed_point_t singular_vector_buffer[3], matrix_column_buffer[3], outer_product_matrix_buffer[9], intermediate_matrix_buffer[9], second_vector_computing_matrix_buffer[9], gradient_buffer[3];
...
bool svd_calculate_v(matrix_t* result) {
    ...
    matrix_init(&singular_vector, AtA.cols, 1, singular_vector_buffer);
    matrix_init(&matrix_column, AtA.cols, 1, matrix_column_buffer);
    matrix_init(&outer_product_matrix, AtA.rows, AtA.cols, outer_product_matrix_buffer);
    ...
    for (int8_t i = 0; i < AtA.cols; ++i) {
        if (i == 0) {
            ...
            matrix_multiply(&outer_product_matrix, &AtA, &intermediate_matrix, intermediate_matrix_buffer);
            matrix_multiply(&intermediate_matrix, &outer_product_matrix,
                            &second_vector_computing_matrix, second_vector_computing_matrix_buffer);
